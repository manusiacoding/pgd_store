        ...
        <div class="content-wrapper">
            ...
            <div class="content-body">
                ...
                <section id="dashboard-ecommerce">
                        ...
                        <div class="col-xl-12 col-md-12 col-12">
                            <div class="card card-statistics">
                                <div class="card-header">
                                    <h4 class="card-title">Data Pemilik Produk</h4>
                                        ...
                                        <div class="col-xl-3 col-sm-6 col-12 mb-2 mb-sm-0 mt-3">
                                            <div class="media">
                                                ...
                                                <div class="media-body my-auto">
                                                    <h4 class="font-weight-bolder mb-0">{{ $item->Total }}</h4>
                                                    <p class="card-text font-small-3 mb-0">{{ $item->produk }}</p>
                                                </div>
                                            </div>
                                        </div>
                                        @endforeach
                    ...
                    @include('dashboard.staff.chart.all-produk-pie')
