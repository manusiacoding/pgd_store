                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form id="createRole" class="form" method="POST" action="{{ route('role.store') }}">
                                            <div class="form-group">
                                                <label for="nama_lengkap">Nama Role</label>
                                                <input type="text" id="nama_lengkap" class="form-control" placeholder="Nama Role" name="name" />
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="col-12">
                                                <button class="btn btn-primary mr-1">Create Role</button>
